...
<section class="big-background">
        <a id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=yFeF4CEu4gA',containment:'body',autoPlay:true, mute:true, startAt:0, opacity:1}"></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="rule.html">Rule of our Free Company</a></li>                            
